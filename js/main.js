...
$(function() {
    ...
    function close_preloader() {
        ...
        setTimeout(function() {
            //$(".cssload-plane").css({animation: "none"});
            /*anime({
    		   targets: '#preloader',
              opacity: [1, 0],
              scale: 4,
            ...
            //preloader.style.cssText="opacity: 0;transform: scale(4);-webkit-transform: scale(4);";
    ...
    var bar4 = new ProgressBar.Line(lineprog1, {
        strokeWidth: 1.72,
        easing: 'easeInOut',
        duration: 1400,
        delay: 300,
    ...
    var bar5 = new ProgressBar.Line(lineprog2, {
        strokeWidth: 1.72,
        easing: 'easeInOut',
        duration: 1400,
        delay: 400,
    ...
    var bar6 = new ProgressBar.Line(lineprog3, {
        strokeWidth: 1.72,
        easing: 'easeInOut',
        duration: 1400,
        delay: 500,
    ...
    var bar7 = new ProgressBar.Line(lineprog4, {
        strokeWidth: 1.72,
        easing: 'easeInOut',
        duration: 1400,
        delay: 600,
    ...
    var bar8 = new ProgressBar.Line(lineprog5, {
        strokeWidth: 1.72,
        easing: 'easeInOut',
        duration: 1400,
        delay: 700,
    ...
    function load_animations() {
        ...
        /*anime({
          targets: ['.art-counter', '.art-counter-frame'],
          delay: 50,
          opacity: [0, 1],
          complete: function(anim) {
            $('.art-counter').each(function() {
